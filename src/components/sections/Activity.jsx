    ...
    <>
      <Section id="activity" className="pb-20 bg-gray-200 dark:bg-[#222]">
        <Container className="flex flex-col items-center justify-center gap-4">
          {data.heading && (
            <h2 className="font-heading text-3xl font-bold text-brand-primary dark:text-brand-secondary">
              {data.heading}
            </h2>
          )}
          {data.description && (
            <p className="max-w-3xl text-center text-text dark:text-text-dark/70">
              {data.description}
            </p>
          )}
