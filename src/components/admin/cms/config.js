  ...
  about: {
    ...
    fields: [
      ...
      { key: "description", label: "Description", type: "textarea" },
      {
        ...
        label: "Profile Image",
        type: "image",
        description: "JPG, PNG, or WebP · automatically optimized",
      },
    ],
  ...
  contact: {
    ...
    groups: [
      ...
      },
      {
        ...
        itemTitle: "Contact Address",
        empty: { label: "", value: "", icon: "MapPin", linkUrl: "" },
        fields: [
          { key: "label", label: "Label" },
          { key: "value", label: "Contact Detail" },
          { key: "icon", label: "Icon", type: "icon" },
          { key: "linkUrl", label: "Clickable Link" },
        ],
      },
      {
        key: "socialLinks",
        title: "Social Profiles",
        itemTitle: "Social Profile",
        empty: { label: "", icon: "Globe", url: "" },
        fields: [
          { key: "label", label: "Profile Name" },
          { key: "icon", label: "Icon" },
          { key: "url", label: "Profile Link" },
        ],
      },
    ],
  },
