  ...
  return (
    <main className="min-h-screen py-30">
      <Container className="mx-auto max-w-5xl">
        ...
        {post.featuredImage && (
          <div className="relative mx-auto mb-10 aspect-[16/9] w-[90%] overflow-hidden rounded-3xl lg:w-2/3">
            <Image
              ...
              fill
              priority
              sizes="(max-width: 1024px) 90vw, 670px"
        ...
        <h1 className="mb-8 font-heading text-3xl font-bold text-heading-soft dark:text-heading-dark/80 lg:text-5xl">
          {post.title}
        </h1>
        <article
          className="whitespace-pre-line text-lg leading-relaxed text-text dark:text-text-dark/70"
